			...
			<div className='container my-5'>
				...
				<div className='row justify-content-center align-items-center'>
					<div className='col-12 col-lg-4 p-2 '>
						<Image className='rounded shadow' src={img1} style={{ objectFit:'cover', width:'inherit', height:'inherit'}}></Image>
					</div>
					<div className='col-12 col-lg-4 p-2'>
						<div className='row justify-content-center align-items-center'>
							<div className='col-12 col-lg-10 p-2'>
								<Image className='rounded shadow' src={img1} style={{ objectFit:'cover' }} ></Image>
							</div>
							<div className='col-12 col-lg-10 p-2'>
								<Image className='rounded shadow' src={img1} style={{ width : '100%', height:'auto' }}></Image>
							</div>
			...
			<div className='w-100 my-5 bg-primary' style={{overflow: 'hidden'}}>
				<div className='container'>
					<div className='row justify-content-center py-3 align-items-center'>
						<div className='d-none d-lg-block col-lg-6' style={{maxHeight: '400px'}}>
							<div style={{
								width : '300px',
								height : '300px',
						...
						<div className='col-12 col-lg-6 py-4 text-white p-5'>
							...
							<p style={{fontSize : '70%'}}>Subscribe with Email and loads of interesting news will be sent to you on a daily basis.</p>
							<div className="input-group mb-3 shadow">
								<input type="text" className="form-control" placeholder="Your email here" aria-label="Recipient's username" aria-describedby="button-addon2"/>
								<button className="btn btn-outline-primary text-white" type="button" id="button-addon2">Subscribe</button>
							</div>
						</div>
					</div>
				</div>
